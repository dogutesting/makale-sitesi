...
export async function getStaticProps() {
  ...
  const jsonContentArray = [
    ...
    },        
    {
        ...
        "ulke": "Japonya",
        "yakitKapasitesi": "5.7",
        "paragraf": "Honda Activa 100, Japon motosiklet üreticisi Honda'nın güvenilir ve ekonomik bir scooter modelidir. 100cc motor hacmi ile düşük yakıt tüketimi ve günlük ulaşım için yeterli performans sunar. Honda'nın kalitesi ve güvenilirliği ile birleşen bu model, kullanıcılar için uzun ömürlü ve düşük bakım maliyetli bir seçenek haline gelir. Geniş depolama alanı ve konforlu koltuk, Honda Activa 100'ü pratik ve kullanıcı dostu bir scooter haline getirir. Otomatik şanzıman ve kolay kullanımı, her yaş grubundan sürücüler için uygun bir seçenek olmasını sağlar."
    },        
    {
        "num": "8",
...
export default function Eniyi125ccScooterMain({baslik, description, keywordsArray, ana_resim, url, jsonList, addDate, okunmaSuresi, kategori, metin, jsonContentArray}) {
