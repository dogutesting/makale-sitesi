...
export default function Eniyi250ccSuperMain() {
  ...
  const baslik = "En İyi 10 250 CC Super Sport Motosikletler";
  ...
  const jsonContentArray = [
    ...
    },
    {
      ...
      "tuketim": "3.5",
      "agirlik": "130",
      "paragraf": <p>Megelli Sport 250 R, sportif tasarımı ve etkileyici performansı ile dikkat çeker. Agresif hatları ve aerodinamik yapısı, dinamik bir sürüş deneyimi sunar. Motor, enerjik ve canlı, yüksek devirlerde bile güç kaybetmiyor. Yol tutuşu sağlam, frenler ise etkili ve güvenilir. Süspansiyon sistemi, sportif sürüşler için ideal sertlikte. Megelli Sport 250 R, 250cc süpersport segmentinde uygun fiyatlı ve performans odaklı bir seçenek sunar.</p>
    },
    {
        "num": "7",
